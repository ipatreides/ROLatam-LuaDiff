...
Table[1]:SetCaution("Encantamiento disponible para Traje y Túnica del Lobo Gris con refinamiento de +7 o superior(Las opciones adicionales según el nivel de refinado no se aplican)\nProbabilidad de éxito del encantamiento normal: 100%\nProbabilidad de reinicio del encantamiento: 100%")
...
Table[2]:SetCaution("Encantamiento disponible para Manto y Bufanda del Lobo Gris con refinamiento de +7 o superior(Las opciones adicionales según el nivel de refinado no se aplican)\nProbabilidad de éxito del encantamiento normal: 100%\nProbabilidad de reinicio del encantamiento: 100%")
...
Table[20]:SetCaution("Encantamiento del Emblema del Héroe\nProbabilidad de éxito 100%\nProbabilidad de reinicialización 100% Si falla, no se destruirá")
...
Table[21]:SetCaution("Encantamiento de las Botas del Héroe-LT\nProbabilidad de éxito 100%\nProbabilidad de reinicialización 100% Si falla, no se destruirá")
...
Table[22]:SetCaution("Encantamiento del Globo de Porings\nProbabilidad de éxito 100%\nProbabilidad de reinicialización 100% Si falla, no se destruirá")
...
Table[23]:SetCaution("Encantamiento de la Hoja Joven del Árbol Mundial\nProbabilidad de éxito 100%\nProbabilidad de reinicialización 100% Si falla, no se destruirá")
...
Table[103]:SetCaution("Conceder el encantamiento del Sombrero del Oficial-LT\nProbabilidad de reinicialización 100%")
...
Table[104]:SetCaution("Encantamiento de la Aflicción de Thanatos Caído-LT\nProbabilidad de éxito del encantamiento común: 100%\nProbabilidad de reinicialización 80%")
