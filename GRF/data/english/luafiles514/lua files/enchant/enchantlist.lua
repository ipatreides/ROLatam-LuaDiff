...
Table[1]:SetCaution([[
Enchant can be applied to Gray Wolf Suits and Robes refined to +7 or higher(Additional options according to refinement level are not applied)?
Normal Enchant success rate: 100%
Enchant reset rate: 100%]])
...
Table[2]:SetCaution([[
Enchant can be applied to Gray Wolf Manteaus and Mufflers refined to +7 or higher(Additional options according to refinement level are not applied)?
Normal Enchant success rate: 100%
Enchant reset rate: 100%]])
...
Table[3]:SetCaution([[
Enchant can be applied to Gray Wolf Boots and Shoes refined to +7 or higher(Additional options according to refinement level are not applied)?
Normal Enchant success rate: 100%
Enchant reset rate: 100%]])
...
Table[4]:SetCaution([[
Enchant can be applied to Gray Wolf Pendants and Earrings.(Additional options based on the refine level will not be applied.)
Normal Enchant success rate: 100%
Enchant reset rate: 100%]])
...
Table[5]:SetCaution([[
Enchant can be applied to Gray Wolf Rings and Necklaces(Additional options according to refinement level are not applied)?
Normal Enchant success rate: 100%
Enchant reset rate: 100%]])
...
Table[15]:SetCaution([[
Mad Bunny-LT Enchant
Success chance 100%
Reset chance 100% If it fails, it will not be destroyed]])
...
Table[23]:SetCaution([[
World Tree's Young Leaf Enchant
Success chance 100%
Reset chance 100% If it fails, it will not be destroyed]])
...
Table[14]:SetCaution([[
2021 Summer Popcorn Event Item Enchant
