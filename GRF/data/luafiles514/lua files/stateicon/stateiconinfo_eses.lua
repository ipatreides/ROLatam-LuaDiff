StateIconList_string = {
	...
	[EFST_IDs.EFST_ENCHANTPOISON] = {
		descript = {
			{
				"Encantamiento de Veneno"
			},
			{"%s"},
			{
				"Encantamiento de Propiedad Veneno en la arma equipada"
			}
		}
	},
	...
	[EFST_IDs.EFST_DEADLY_DEFEASANCE] = {
		descript = {
			...
			{"%s"},
			{
				"Cancela el efecto de Inmunidad Mágica"
			}
		}
	},
	...
	[EFST_IDs.EFST_HANDICAPSTATE_LIGHTNINGSTRIKE] = {
		descript = {
			...
			{
				"Reduce resist. a Tierra"
			},
			{
				"Não es posible moverse, usar"
			},
			{
				"objetos o habilidades"
			}
		}
	},
	[EFST_IDs.EFST_HANDICAPSTATE_CRYSTALLIZATION] = {
		descript = {
			...
			{"%s"},
			{
				"Armadura de prop. Tierra"
			},
			{
				"DEFM reducida"
			},
			{
				"No es posible moverse, usar objetos o habilidades"
			}
		}
	},
	...
	[EFST_IDs.EFST_RUSH_QUAKE1] = {
		descript = {
			...
			{"%s"},
			{
				"Recibe más daño a distancia y cuerpo a cuerpo."
			}
		}
	},
