SKILL_DESCRIPT = {
	...
	[SKID.GC_DARKCROW] = {
		...
		"Description : ^777777Inflicts a wound that deals melee physical",
		"damage, and removes target's damage",
		"reflection effect from skills.",
		"Wound continues for 20 sec. The target's",
		"damage reflect effect from skills stays",
		"disabled for the duration of the wound and",
		"the target receives more damage from",
		"melee physical attacks.",
		"Only the half of damage amplification",
		"applies to Boss monsters.^000000",
