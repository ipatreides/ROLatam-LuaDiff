SkillInfoList_string = {
	...
	[SKID.SM_BASH] = {SkillName = "Bash"},
	[SKID.SM_PROVOKE] = {SkillName = "Provoke"},
	[SKID.SM_MAGNUM] = {
		SkillName = "Magnum Break"
	},
	[SKID.SM_ENDURE] = {SkillName = "Endure"},
	[SKID.MG_SRECOVERY] = {
		SkillName = "Increase SP Recovery"
	},
	[SKID.MG_SIGHT] = {SkillName = "Sight"},
	[SKID.MG_NAPALMBEAT] = {
	...
	[SKID.MG_COLDBOLT] = {SkillName = "Cold Bolt"},
	[SKID.MG_FROSTDIVER] = {
	...
	[SKID.MG_FIREBALL] = {SkillName = "Fire Ball"},
	[SKID.MG_FIREWALL] = {SkillName = "Fire Wall"},
	[SKID.MG_FIREBOLT] = {SkillName = "Fire Bolt"},
	...
	[SKID.AL_DEMONBANE] = {SkillName = "Demon Bane"},
	[SKID.AL_RUWACH] = {SkillName = "Ruwach"},
	[SKID.AL_PNEUMA] = {SkillName = "Pneuma"},
	[SKID.AL_TELEPORT] = {SkillName = "Teleport"},
	[SKID.AL_WARP] = {
		SkillName = "Warp Portal"
	},
	[SKID.AL_HEAL] = {SkillName = "Heal"},
	[SKID.AL_INCAGI] = {
	...
	[SKID.AL_ANGELUS] = {SkillName = "Angelus"},
	[SKID.AL_BLESSING] = {SkillName = "Blessing"},
	[SKID.AL_CURE] = {SkillName = "Cure"},
	[SKID.MC_INCCARRY] = {
		SkillName = "Enlarge Weight Limit"
	},
	[SKID.MC_DISCOUNT] = {SkillName = "Discount"},
	[SKID.MC_OVERCHARGE] = {SkillName = "Overcharge"},
	[SKID.MC_PUSHCART] = {SkillName = "Pushcart"},
	[SKID.MC_IDENTIFY] = {
		SkillName = "Item Appraisal"
	},
	[SKID.MC_VENDING] = {SkillName = "Vending"},
	[SKID.MC_MAMMONITE] = {SkillName = "Mammonite"},
	[SKID.AC_OWL] = {SkillName = "Owl's Eye"},
	[SKID.AC_VULTURE] = {
	...
	[SKID.TF_STEAL] = {SkillName = "Steal"},
	[SKID.TF_HIDING] = {SkillName = "Hiding"},
	[SKID.TF_POISON] = {SkillName = "Envenom"},
	[SKID.TF_DETOXIFY] = {SkillName = "Detoxify"},
	...
	[SKID.KN_PIERCE] = {SkillName = "Pierce"},
	[SKID.KN_BRANDISHSPEAR] = {
		SkillName = "Brandish Spear"
	},
	[SKID.KN_SPEARSTAB] = {SkillName = "Spear Stab"},
	...
	[SKID.PR_SUFFRAGIUM] = {SkillName = "Suffragium"},
	[SKID.PR_ASPERSIO] = {SkillName = "Aspersio"},
	[SKID.PR_BENEDICTIO] = {
		SkillName = "B.S Sacramenti "
	},
	[SKID.PR_SANCTUARY] = {SkillName = "Sanctuary"},
	[SKID.PR_SLOWPOISON] = {
	...
	[SKID.PR_MAGNIFICAT] = {SkillName = "Magnificat"},
	[SKID.PR_GLORIA] = {SkillName = "Gloria"},
	[SKID.PR_LEXDIVINA] = {SkillName = "Lex Divina"},
	[SKID.PR_TURNUNDEAD] = {
	...
	[SKID.WZ_FIREIVY] = {SkillName = "Fire Ivy"},
	[SKID.WZ_METEOR] = {
	...
	[SKID.WZ_WATERBALL] = {SkillName = "Waterball"},
	[SKID.WZ_ICEWALL] = {SkillName = "Ice Wall"},
	[SKID.WZ_FROSTNOVA] = {SkillName = "Frost Nova"},
	[SKID.WZ_STORMGUST] = {SkillName = "Storm Gust"},
	[SKID.WZ_EARTHSPIKE] = {
	...
	[SKID.WZ_QUAGMIRE] = {SkillName = "Quagmire"},
	[SKID.WZ_ESTIMATION] = {SkillName = "Sense"},
	[SKID.BS_IRON] = {
	...
	[SKID.BS_AXE] = {SkillName = "Smith Axe"},
	[SKID.BS_MACE] = {SkillName = "Smith Mace"},
	[SKID.BS_KNUCKLE] = {
	...
	[SKID.BS_HAMMERFALL] = {SkillName = "Hammerfall"},
	[SKID.BS_ADRENALINE] = {
	...
	[SKID.HT_SKIDTRAP] = {SkillName = "Skid Trap"},
	[SKID.HT_LANDMINE] = {SkillName = "Land Mine"},
	[SKID.HT_ANKLESNARE] = {SkillName = "Anklesnare"},
	[SKID.HT_SHOCKWAVE] = {
		SkillName = "Shockwave Trap"
	},
	[SKID.HT_SANDMAN] = {SkillName = "Sandman"},
	[SKID.HT_FLASHER] = {SkillName = "Flasher"},
	[SKID.HT_FREEZINGTRAP] = {
		SkillName = "Freezing Trap"
	},
	[SKID.HT_BLASTMINE] = {SkillName = "Blast Mine"},
	...
	[SKID.HT_TALKIEBOX] = {SkillName = "Talkie Box"},
	[SKID.HT_BEASTBANE] = {SkillName = "Beastbane"},
	[SKID.HT_FALCON] = {
		SkillName = "Falconry Mastery"
	},
	[SKID.HT_STEELCROW] = {SkillName = "Steel Crow"},
	[SKID.HT_BLITZBEAT] = {SkillName = "Blitz Beat"},
	[SKID.HT_DETECTING] = {SkillName = "Detect"},
	[SKID.HT_SPRINGTRAP] = {
	...
	[SKID.AS_CLOAKING] = {SkillName = "Cloaking"},
	[SKID.AS_SONICBLOW] = {SkillName = "Sonic Blow"},
	[SKID.AS_GRIMTOOTH] = {SkillName = "Grimtooth"},
	...
	[SKID.AS_VENOMDUST] = {SkillName = "Venom Dust"},
	[SKID.AS_SPLASHER] = {
		SkillName = "Venom Splasher"
	},
	[SKID.NV_FIRSTAID] = {SkillName = "First Aid"},
	[SKID.NV_TRICKDEAD] = {SkillName = "Play Dead"},
	[SKID.SM_MOVINGRECOVERY] = {
		SkillName = "HP Recovery While Moving"
	},
	[SKID.SM_FATALBLOW] = {SkillName = "Fatal Blow"},
	[SKID.SM_AUTOBERSERK] = {SkillName = "Berserk"},
	[SKID.AC_MAKINGARROW] = {
	...
	[SKID.TF_BACKSLIDING] = {SkillName = "Back Slide"},
	[SKID.TF_PICKSTONE] = {SkillName = "Find Stone"},
	[SKID.TF_THROWSTONE] = {
	...
	[SKID.AL_HOLYLIGHT] = {SkillName = "Holy Light"},
	[SKID.MG_ENERGYCOAT] = {
	...
	[SKID.RG_SNATCHER] = {SkillName = "Gank"},
	[SKID.RG_STEALCOIN] = {SkillName = "Mug"},
	[SKID.RG_BACKSTAP] = {SkillName = "Back Stab"},
	[SKID.RG_TUNNELDRIVE] = {SkillName = "Stalk"},
	[SKID.RG_RAID] = {
	...
	[SKID.RG_INTIMIDATE] = {SkillName = "Snatch"},
	[SKID.RG_GRAFFITI] = {SkillName = "Scribble"},
	[SKID.RG_FLAGGRAFFITI] = {SkillName = "Piece"},
	[SKID.RG_CLEANER] = {SkillName = "Remover"},
	[SKID.RG_GANGSTER] = {SkillName = "Slyness"},
	[SKID.RG_COMPULSION] = {SkillName = "Haggle"},
	[SKID.RG_PLAGIARISM] = {SkillName = "Intimidate"},
	[SKID.AM_AXEMASTERY] = {
	...
	[SKID.AM_DEMONSTRATION] = {SkillName = "Bomb"},
	[SKID.AM_ACIDTERROR] = {
		SkillName = "Acid Terror"
	},
	[SKID.AM_POTIONPITCHER] = {SkillName = "Aid Potion"},
	[SKID.AM_CANNIBALIZE] = {
	...
	[SKID.AM_BIOETHICS] = {SkillName = "Bioethics"},
	...
	[SKID.AM_REST] = {SkillName = "Vaporize"},
	[SKID.AM_DRILLMASTER] = {
	...
	[SKID.CR_TRUST] = {SkillName = "Faith"},
	[SKID.CR_AUTOGUARD] = {SkillName = "Guard"},
	[SKID.CR_SHIELDCHARGE] = {SkillName = "Smite"},
	...
	[SKID.CR_HOLYCROSS] = {SkillName = "Holy Cross"},
	[SKID.CR_GRANDCROSS] = {
		SkillName = "Grand Cross"
	},
	[SKID.CR_DEVOTION] = {SkillName = "Sacrifice"},
	[SKID.CR_PROVIDENCE] = {
	...
	[SKID.MO_IRONHAND] = {SkillName = "Iron Fists"},
	...
	[SKID.MO_BODYRELOCATION] = {SkillName = "Snap"},
	[SKID.MO_DODGE] = {SkillName = "Flee"},
	[SKID.MO_INVESTIGATE] = {
	...
	[SKID.MO_BLADESTOP] = {SkillName = "Root"},
	[SKID.MO_EXPLOSIONSPIRITS] = {SkillName = "Fury"},
	...
	[SKID.SA_ADVANCEDBOOK] = {SkillName = "Study"},
	[SKID.SA_CASTCANCEL] = {
		SkillName = "Cast Cancel"
	},
	[SKID.SA_MAGICROD] = {SkillName = "Magic Rod"},
	[SKID.SA_SPELLBREAKER] = {
		SkillName = "Spell Breaker"
	},
	[SKID.SA_FREECAST] = {SkillName = "Free Cast"},
	[SKID.SA_AUTOSPELL] = {SkillName = "Hindsight"},
	...
	[SKID.SA_VOLCANO] = {SkillName = "Volcano"},
	[SKID.SA_DELUGE] = {SkillName = "Deluge"},
	[SKID.SA_VIOLENTGALE] = {SkillName = "Whirlwind"},
	[SKID.SA_LANDPROTECTOR] = {
		SkillName = "Land Protector"
	},
	[SKID.SA_DISPELL] = {SkillName = "Dispell"},
	[SKID.SA_ABRACADABRA] = {
		SkillName = "Hocus-pocus"
	},
	[SKID.SA_MONOCELL] = {SkillName = "Mono Cell"},
	[SKID.SA_CLASSCHANGE] = {
	...
	[SKID.SA_GRAVITY] = {SkillName = "Gravity"},
	[SKID.SA_LEVELUP] = {SkillName = "Leveling"},
	[SKID.SA_INSTANTDEATH] = {SkillName = "Suicide"},
	[SKID.SA_FULLRECOVERY] = {
		SkillName = "Rejuvenation"
	},
	[SKID.SA_COMA] = {SkillName = "Coma"},
	[SKID.BD_ADAPTATION] = {SkillName = "Amp"},
	[SKID.BD_ENCORE] = {SkillName = "Encore"},
	[SKID.BD_LULLABY] = {SkillName = "Lullaby"},
	[SKID.BD_RICHMANKIM] = {
		SkillName = "Mental Sensing"
	},
	[SKID.BD_ETERNALCHAOS] = {SkillName = "Down Tempo"},
	...
	[SKID.BD_INTOABYSS] = {SkillName = "Power Cord"},
	[SKID.BD_SIEGFRIED] = {
		SkillName = "Acoustic Rhythm"
	},
	[SKID.BD_RAGNAROK] = {SkillName = "Ragnarok"},
	...
	[SKID.DC_UGLYDANCE] = {SkillName = "Hip Shaker"},
	[SKID.DC_SCREAM] = {SkillName = "Dazzler"},
	[SKID.DC_HUMMING] = {
		SkillName = "Focus Ballet"
	},
	[SKID.DC_DONTFORGETME] = {SkillName = "Slow Grace"},
	[SKID.DC_FORTUNEKISS] = {SkillName = "Lady Luck"},
	...
	[SKID.LK_AURABLADE] = {SkillName = "Aura Blade"},
	[SKID.LK_PARRYING] = {SkillName = "Parry"},
	[SKID.LK_CONCENTRATION] = {
		SkillName = "Spear Dynamo"
	},
	[SKID.LK_TENSIONRELAX] = {SkillName = "Relax"},
	[SKID.LK_BERSERK] = {SkillName = "Frenzy"},
	[SKID.HP_ASSUMPTIO] = {SkillName = "Assumptio"},
	[SKID.HP_BASILICA] = {SkillName = "Basilica"},
	[SKID.HP_MEDITATIO] = {SkillName = "Meditation"},
	[SKID.HW_SOULDRAIN] = {SkillName = "Soul Drain"},
	...
	[SKID.PF_HPCONVERSION] = {SkillName = "Indulge"},
	[SKID.PF_SOULCHANGE] = {
	...
	[SKID.WS_CREATECOIN] = {SkillName = "Coin Craft"},
	[SKID.WS_CREATENUGGET] = {
		SkillName = "Nugget Craft"
	},
	[SKID.WS_CARTBOOST] = {SkillName = "Cart Boost"},
	[SKID.WS_SYSTEMCREATE] = {
		SkillName = "Battle Machine Craft"
	},
	[SKID.ST_CHASEWALK] = {SkillName = "Stealth"},
	[SKID.ST_REJECTSWORD] = {
	...
	[SKID.CR_ALCHEMY] = {SkillName = "Alchemy"},
	...
	[SKID.CH_SOULCOLLECT] = {SkillName = "Zen"},
	[SKID.PF_MINDBREAKER] = {
		SkillName = "Mind Breaker"
	},
	[SKID.PF_MEMORIZE] = {SkillName = "Foresight"},
	[SKID.PF_FOGWALL] = {
		SkillName = "Blinding Mist"
	},
	[SKID.PF_SPIDERWEB] = {SkillName = "Fiber Lock"},
	...
	[SKID.TK_DOWNKICK] = {SkillName = "Heel Drop"},
	[SKID.TK_READYTURN] = {
		SkillName = "Roundhouse Stance"
	},
	[SKID.TK_TURNKICK] = {SkillName = "Roundhouse"},
	...
	[SKID.TK_DODGE] = {SkillName = "Tumbling"},
	[SKID.TK_JUMPKICK] = {
	...
	[SKID.TK_POWER] = {SkillName = "Kihop"},
	[SKID.TK_SEVENWIND] = {SkillName = "Mild Wind"},
	[SKID.TK_HIGHJUMP] = {SkillName = "Leap"},
	[SKID.SG_FEEL] = {
		SkillName = "Solar, Lunar and Stellar Perception"
	},
	[SKID.SG_SUN_WARM] = {SkillName = "Solar Heat"},
	[SKID.SG_MOON_WARM] = {SkillName = "Lunar Heat"},
	[SKID.SG_STAR_WARM] = {
	...
	[SKID.SL_KAIZEL] = {SkillName = "Kaizel"},
	[SKID.SL_KAAHI] = {SkillName = "Kaahi"},
	[SKID.SL_KAUPE] = {SkillName = "Kaupe"},
	[SKID.SL_KAITE] = {SkillName = "Kaite"},
	[SKID.SL_KAINA] = {SkillName = "Kaina"},
	[SKID.SL_STIN] = {SkillName = "Estin"},
	[SKID.SL_STUN] = {SkillName = "Estun"},
	[SKID.SL_SMA] = {SkillName = "Esma"},
	[SKID.SL_SWOO] = {SkillName = "Eswoo"},
	[SKID.SL_SKE] = {SkillName = "Eske"},
	[SKID.SL_SKA] = {SkillName = "Eska"},
	[SKID.ST_PRESERVE] = {SkillName = "Preserve"},
	[SKID.ST_FULLSTRIP] = {
	...
	[SKID.HW_GANBANTEIN] = {SkillName = "Ganbantein"},
	[SKID.HW_GRAVITATION] = {
	...
	[SKID.CR_ACIDDEMONSTRATION] = {SkillName = "Acid Bomb"},
	[SKID.CR_CULTIVATION] = {
	...
	[SKID.GS_GLITTERING] = {SkillName = "Coin Flip"},
	[SKID.GS_FLING] = {SkillName = "Coin Fling"},
	[SKID.GS_TRIPLEACTION] = {
		SkillName = "Triple Action"
	},
	[SKID.GS_BULLSEYE] = {SkillName = "Bull's Eye"},
	[SKID.GS_MADNESSCANCEL] = {SkillName = "Last Stand"},
	[SKID.GS_ADJUSTMENT] = {
	...
	[SKID.GS_CRACKER] = {SkillName = "Cracker"},
	[SKID.GS_SINGLEACTION] = {
		SkillName = "Single Action"
	},
	[SKID.GS_SNAKEEYE] = {SkillName = "Snake Eyes"},
	[SKID.GS_CHAINACTION] = {
		SkillName = "Chain Action"
	},
	[SKID.GS_TRACKING] = {SkillName = "Tracking"},
	[SKID.GS_DISARM] = {SkillName = "Disarm"},
	...
	[SKID.GS_DESPERADO] = {SkillName = "Desperado"},
	...
	[SKID.GS_FULLBUSTER] = {SkillName = "Full Blast"},
	...
	[SKID.NJ_HUUJIN] = {SkillName = "Wind Blade"},
	[SKID.NJ_RAIGEKISAI] = {
		SkillName = "Lightning Jolt"
	},
	[SKID.NJ_KAMAITACHI] = {SkillName = "First Wind"},
	[SKID.NJ_NEN] = {SkillName = "Ninja Aura"},
	[SKID.NJ_ISSEN] = {
	...
	[SKID.MB_BODYSTUDY] = {SkillName = "Body Study"},
	[SKID.MB_BODYALTER] = {SkillName = "Alter Body"},
	[SKID.MB_PETMEMORY] = {SkillName = "Pet Memory"},
	[SKID.MB_M_TELEPORT] = {
	...
	[SKID.MB_M_GAIN] = {SkillName = "Munak Gain"},
	[SKID.MB_MISSION] = {
	...
	[SKID.MB_MUNAKBALL] = {SkillName = "Munak Ball"},
	[SKID.MB_SCROLL] = {SkillName = "Pet Scroll"},
	[SKID.MB_B_GATHERING] = {
	...
	[SKID.DA_DARKPOWER] = {SkillName = "Dark Power"},
	[SKID.DE_PASSIVE] = {
	...
	[SKID.DE_PHP] = {SkillName = "Death HP"},
	[SKID.DE_PSP] = {SkillName = "Death SP"},
	[SKID.DE_RESET] = {
		SkillName = "Death Reset"
	},
	[SKID.DE_RANKING] = {SkillName = "Ranking"},
	[SKID.DE_PTRIPLE] = {
		SkillName = "Death Triple"
	},
	[SKID.DE_ENERGY] = {SkillName = "Energy"},
	[SKID.DE_NIGHTMARE] = {SkillName = "Nightmare"},
	[SKID.DE_SLASH] = {SkillName = "Slash"},
	[SKID.DE_COIL] = {SkillName = "Coil"},
	[SKID.DE_WAVE] = {SkillName = "Wave"},
	[SKID.DE_REBIRTH] = {SkillName = "Rebirth"},
	[SKID.DE_AURA] = {SkillName = "Aura"},
	[SKID.DE_FREEZER] = {SkillName = "Freezer"},
	...
	[SKID.DE_INSTANT] = {SkillName = "Instant"},
	[SKID.DE_WARNING] = {SkillName = "Warning"},
	[SKID.DE_RANKEDKNIFE] = {
	...
	[SKID.DE_GAUGE] = {SkillName = "Gauge"},
	[SKID.DE_GTIME] = {SkillName = "G Time"},
	[SKID.DE_GPAIN] = {SkillName = "G Pain"},
	[SKID.DE_GSKILL] = {SkillName = "G Skill"},
	[SKID.DE_GKILL] = {SkillName = "G Kill"},
	[SKID.DE_ACCEL] = {
	...
	[SKID.DE_BLOCKFAR] = {SkillName = "Far Black"},
	[SKID.DE_FRONTATTACK] = {
	...
	[SKID.DA_ENERGY] = {SkillName = "Energy"},
	[SKID.DA_CLOUD] = {SkillName = "Cloud"},
	[SKID.DA_FIRSTSLOT] = {SkillName = "First Slot"},
	[SKID.DA_HEADDEF] = {
		SkillName = "Head Defense"
	},
	[SKID.DA_SPACE] = {SkillName = "Space"},
	[SKID.DA_TRANSFORM] = {SkillName = "Transform"},
	[SKID.DA_EXPLOSION] = {SkillName = "Explosion"},
	[SKID.DA_REWARD] = {SkillName = "Reward"},
	[SKID.DA_CRUSH] = {SkillName = "Crush"},
	[SKID.DA_ITEMREBUILD] = {
		SkillName = "Item Rebuild"
	},
	[SKID.DA_ILLUSION] = {SkillName = "Illusion"},
	[SKID.DA_NUETRALIZE] = {SkillName = "Neutralize"},
	[SKID.DA_RUNNER] = {SkillName = "Runner"},
	[SKID.DA_TRANSFER] = {SkillName = "Transfer"},
	[SKID.DA_WALL] = {SkillName = "Wall"},
	[SKID.DA_REVENGE] = {SkillName = "Revenge"},
	[SKID.DA_EARPLUG] = {SkillName = "Earplug"},
	[SKID.DA_CONTRACT] = {SkillName = "Contract"},
	[SKID.DA_BLACK] = {SkillName = "Black"},
	[SKID.DA_DREAM] = {SkillName = "Dream"},
	[SKID.DA_MAGICCART] = {SkillName = "Magic Cart"},
	[SKID.DA_COPY] = {SkillName = "Copy"},
	[SKID.DA_CRYSTAL] = {SkillName = "Crystal"},
	[SKID.DA_EXP] = {SkillName = "Experience"},
	[SKID.DA_CARTSWING] = {SkillName = "Cart Swing"},
	[SKID.DA_REBUILD] = {SkillName = "Rebuild"},
	[SKID.DA_JOBCHANGE] = {SkillName = "Job Change"},
	[SKID.DA_EDARKNESS] = {
		SkillName = "Eternal Darkness"
	},
	[SKID.DA_EGUARDIAN] = {SkillName = "Guardian"},
	[SKID.DA_TIMEOUT] = {SkillName = "Time Out"},
	[SKID.ALL_TIMEIN] = {SkillName = "Time"},
	[SKID.DA_ZENYRANK] = {SkillName = "Zeny Rank"},
	[SKID.DA_ACCESSORYMIX] = {
		SkillName = "Accessory mix"
	},
	[SKID.NPC_EARTHQUAKE] = {SkillName = "Earthquake"},
	[SKID.NPC_DRAGONFEAR] = {
	...
	[SKID.NPC_WIDESILENCE] = {SkillName = "Bedlam"},
	[SKID.NPC_WIDEFREEZE] = {
	...
	[SKID.NPC_WIDESIGHT] = {SkillName = "Wide sight"},
	[SKID.NPC_EVILLAND] = {SkillName = "Evil Land"},
	[SKID.NPC_MAGICMIRROR] = {
		SkillName = "Magic Mirror"
	},
	[SKID.NPC_SLOWCAST] = {SkillName = "Slow Cast"},
	[SKID.NPC_CRITICALWOUND] = {
		SkillName = "Critical Wounds"
	},
	[SKID.NPC_STONESKIN] = {SkillName = "Stone Skin"},
	[SKID.NPC_ANTIMAGIC] = {SkillName = "Deadzone"},
	[SKID.NPC_WIDECURSE] = {
	...
	[SKID.NPC_ALLHEAL] = {SkillName = "Full Heal"},
	[SKID.GM_SANDMAN] = {
	...
	[SKID.ALL_WEWISH] = {SkillName = "Marry Xmas"},
	...
	[SKID.NPC_VENOMFOG] = {SkillName = "Venom fog"},
	[SKID.NPC_MILLENNIUMSHIELD] = {
		SkillName = "Escudos Milenares"
	},
	[SKID.NPC_COMET] = {SkillName = "Comet"},
	[SKID.NPC_ICEMINE] = {SkillName = "Ice mine"},
	[SKID.NPC_FLAMECROSS] = {
	...
	[SKID.NPC_MAXPAIN] = {SkillName = "Max Pain"},
	[SKID.NPC_JACKFROST] = {SkillName = "Jack Frost"},
	[SKID.NPC_WIDEWEB] = {SkillName = "Wide web"},
	[SKID.NPC_WIDESUCK] = {
		SkillName = "Wide bloodsucking"
	},
	[SKID.NPC_STORMGUST2] = {SkillName = "Storm Gust"},
	[SKID.NPC_FIRESTORM] = {SkillName = "Fire storm"},
	...
	[SKID.NPC_MAGMA_ERUPTION] = {SkillName = "Lava Flow"},
	[SKID.NPC_MANDRAGORA] = {
	...
	[SKID.NPC_FIREWALK] = {SkillName = "Fire Walk"},
	[SKID.NPC_LEASH] = {SkillName = "Death Grip"},
	[SKID.NPC_WIDELEASH] = {
	...
	[SKID.NPC_EARTHQUAKE_K] = {SkillName = "Earthquake"},
	...
	[SKID.CR_SHRINK] = {SkillName = "Shrink"},
	[SKID.AS_SONICACCEL] = {
	...
	[SKID.BA_PANGVOICE] = {SkillName = "Pang Voice"},
	[SKID.DC_WINKCHARM] = {
	...
	[SKID.BS_GREED] = {SkillName = "Greed"},
	[SKID.PR_REDEMPTIO] = {SkillName = "Redemptio"},
	...
	[SKID.RK_SONICWAVE] = {SkillName = "Sonic Wave"},
	[SKID.RK_DEATHBOUND] = {
	...
	[SKID.RK_REFRESH] = {SkillName = "Refresh"},
	[SKID.RK_GIANTGROWTH] = {
	...
	[SKID.RK_ABUNDANCE] = {SkillName = "Abundance"},
	...
	[SKID.GC_ANTIDOTE] = {SkillName = "Antidote"},
	...
	[SKID.AB_JUDEX] = {SkillName = "Judex"},
	[SKID.AB_ANCILLA] = {SkillName = "Ancilla"},
	[SKID.AB_ADORAMUS] = {SkillName = "Adoramus"},
	[SKID.AB_CLEMENTIA] = {SkillName = "Clementia"},
	[SKID.AB_CANTO] = {
	...
	[SKID.AB_EPICLESIS] = {SkillName = "Epiclesis"},
	[SKID.AB_PRAEFATIO] = {SkillName = "Praefatio"},
	[SKID.AB_ORATIO] = {SkillName = "Oratio"},
	[SKID.AB_LAUDAAGNUS] = {
	...
	[SKID.AB_RENOVATIO] = {SkillName = "Renovatio"},
	[SKID.AB_HIGHNESSHEAL] = {SkillName = "High Heal"},
	[SKID.AB_CLEARANCE] = {SkillName = "Clearance"},
	[SKID.AB_EXPIATIO] = {SkillName = "Expiatio"},
	[SKID.AB_DUPLELIGHT] = {
	...
	[SKID.AB_SILENTIUM] = {SkillName = "Silentium"},
	...
	[SKID.WL_JACKFROST] = {SkillName = "Jack Frost"},
	...
	[SKID.WL_RADIUS] = {SkillName = "Radius"},
	[SKID.WL_STASIS] = {SkillName = "Stasis"},
	[SKID.WL_DRAINLIFE] = {SkillName = "Drain Life"},
	[SKID.WL_CRIMSONROCK] = {
	...
	[SKID.WL_RELEASE] = {SkillName = "Release"},
	[SKID.WL_READING_SB] = {
	...
	[SKID.RA_AIMEDBOLT] = {SkillName = "Aimed Bolt"},
	[SKID.RA_DETONATOR] = {SkillName = "Detonator"},
	...
	[SKID.RA_WUGRIDER] = {SkillName = "Warg Ride"},
	[SKID.RA_WUGDASH] = {SkillName = "Warg Dash"},
	[SKID.RA_WUGSTRIKE] = {
		SkillName = "Warg Strike"
	},
	[SKID.RA_WUGBITE] = {SkillName = "Warg Bite"},
	[SKID.RA_TOOTHOFWUG] = {SkillName = "Warg Teeth"},
	[SKID.RA_SENSITIVEKEEN] = {SkillName = "Keen Nose"},
	[SKID.RA_CAMOUFLAGE] = {SkillName = "Camouflage"},
	...
	[SKID.RA_MAIZETRAP] = {SkillName = "Maze Trap"},
	[SKID.RA_VERDURETRAP] = {
		SkillName = "Verdure Trap"
	},
	[SKID.RA_FIRINGTRAP] = {SkillName = "Fire Trap"},
	[SKID.RA_ICEBOUNDTRAP] = {SkillName = "Ice Trap"},
	[SKID.NC_MADOLICENCE] = {
	...
	[SKID.NC_VULCANARM] = {SkillName = "Vulcan Arm"},
	...
	[SKID.NC_ARMSCANNON] = {SkillName = "Arm Cannon"},
	[SKID.NC_ACCELERATION] = {
		SkillName = "Acceleration"
	},
	[SKID.NC_HOVERING] = {SkillName = "Hover"},
	[SKID.NC_F_SIDESLIDE] = {
		SkillName = "Front Slide"
	},
	[SKID.NC_B_SIDESLIDE] = {SkillName = "Back Slide"},
	[SKID.NC_MAINFRAME] = {
	...
	[SKID.NC_EMERGENCYCOOL] = {SkillName = "Cooldown"},
	[SKID.NC_INFRAREDSCAN] = {
		SkillName = "Infrared Scan"
	},
	[SKID.NC_ANALYZE] = {SkillName = "Analyze"},
	...
	[SKID.NC_REPAIR] = {SkillName = "Repair"},
	[SKID.NC_TRAININGAXE] = {
		SkillName = "Axe Mastery "
	},
	[SKID.NC_RESEARCHFE] = {
	...
	[SKID.SC_REPRODUCE] = {SkillName = "Reproduce"},
	...
	[SKID.SC_MANHOLE] = {SkillName = "Manhole "},
	...
	[SKID.SC_MAELSTROM] = {SkillName = "Maelstrom"},
	[SKID.SC_BLOODYLUST] = {
		SkillName = "Bloody Lust "
	},
	[SKID.SC_FEINTBOMB] = {SkillName = "Feint Bomb"},
	[SKID.LG_CANNONSPEAR] = {
	...
	[SKID.LG_TRAMPLE] = {SkillName = "Trample"},
	[SKID.LG_SHIELDPRESS] = {
	...
	[SKID.LG_OVERBRAND] = {SkillName = "Overbrand"},
	[SKID.LG_PRESTIGE] = {SkillName = "Prestige"},
	[SKID.LG_BANDING] = {SkillName = "Banding"},
	[SKID.LG_MOONSLASHER] = {
	...
	[SKID.SR_SKYNETBLOW] = {SkillName = "Sky Blow"},
	[SKID.SR_EARTHSHAKER] = {
	...
	[SKID.SR_WINDMILL] = {SkillName = "Windmill"},
	...
	[SKID.MI_ECHOSONG] = {SkillName = "Echo Song"},
	[SKID.MI_HARMONIZE] = {SkillName = "Harmonize"},
	[SKID.WM_LESSON] = {
	...
	[SKID.WM_GREAT_ECHO] = {SkillName = "Great Echo"},
	...
	[SKID.SO_FIREWALK] = {SkillName = "Fire Walk"},
	[SKID.SO_ELECTRICWALK] = {
		SkillName = "Electric Walk"
	},
	[SKID.SO_SPELLFIST] = {SkillName = "Spell Fist"},
	[SKID.SO_EARTHGRAVE] = {
	...
	[SKID.SO_STRIKING] = {SkillName = "Striking"},
	[SKID.SO_WARMER] = {SkillName = "Warmer"},
	...
	[SKID.SO_ARRULLO] = {SkillName = "Arrullo"},
	[SKID.SO_EL_CONTROL] = {
		SkillName = "Spirit Control "
	},
	[SKID.SO_SUMMON_AGNI] = {SkillName = "Call Agni"},
	[SKID.SO_SUMMON_AQUA] = {SkillName = "Call Aqua"},
	[SKID.SO_SUMMON_VENTUS] = {
		SkillName = "Call Ventus"
	},
	[SKID.SO_SUMMON_TERA] = {SkillName = "Call Tera"},
	[SKID.SO_EL_ACTION] = {
	...
	[SKID.GN_THORNS_TRAP] = {SkillName = "Thorn Trap"},
	...
	[SKID.GN_WALLOFTHORN] = {SkillName = "Thorn Wall"},
	[SKID.GN_CRAZYWEED] = {
	...
	[SKID.GN_HELLS_PLANT] = {SkillName = "Hell Plant"},
	[SKID.GN_MANDRAGORA] = {
		SkillName = "Mandragora Howl"
	},
	[SKID.GN_SLINGITEM] = {SkillName = "Item Sling"},
	...
	[SKID.AB_SECRAMENT] = {SkillName = "Sacrament"},
	...
	[SKID.NPC_UGLYDANCE] = {SkillName = "Hip Shaker"},
	...
	[SKID.RL_FLICKER] = {SkillName = "Flicker"},
	[SKID.RL_S_STORM] = {
	...
	[SKID.RL_FIREDANCE] = {SkillName = "Fire Dance"},
	[SKID.RL_H_MINE] = {
	...
	[SKID.RL_R_TRIP] = {SkillName = "Round Trip"},
	[SKID.RL_D_TAIL] = {
		SkillName = "Dragon Tail"
	},
	[SKID.RL_FIRE_RAIN] = {SkillName = "Fire Rain"},
	[SKID.RL_HEAT_BARREL] = {SkillName = "Hit Barrel"},
	[SKID.RL_AM_BLAST] = {
		SkillName = "Anti Material Blast"
	},
	[SKID.RL_SLUGSHOT] = {SkillName = "Slug Shot"},
	...
	[SKID.SJ_FLASHKICK] = {SkillName = "Flash Kick"},
	[SKID.SJ_STAREMPEROR] = {
	...
	[SKID.SJ_PROMINENCEKICK] = {SkillName = "Blaze Kick"},
	...
	[SKID.SP_SOULGOLEM] = {SkillName = "Golem Soul"},
	[SKID.SP_SOULSHADOW] = {
	...
	[SKID.SP_SOULFAIRY] = {SkillName = "Fairy Soul"},
	...
	[SKID.SP_SPA] = {SkillName = "Espa"},
	[SKID.SP_SHA] = {SkillName = "Esha"},
	[SKID.SP_SWHOO] = {SkillName = "Eswoo"},
	[SKID.SP_SOULUNITY] = {SkillName = "Soul Bind"},
	...
	[SKID.KO_MAKIBISHI] = {SkillName = "Makibishi"},
	[SKID.KO_MEIKYOUSISUI] = {SkillName = "Pure Soul"},
	[SKID.KO_ZANZOU] = {
	...
	[SKID.KO_KAHU_ENTEN] = {SkillName = "Fire Charm"},
	[SKID.KO_HYOUHU_HUBUKI] = {SkillName = "Ice Charm"},
	[SKID.KO_KAZEHU_SEIRAN] = {SkillName = "Wind Charm"},
	[SKID.KO_DOHU_KOUKAI] = {
	...
	[SKID.KO_IZAYOI] = {SkillName = "16th Night"},
	[SKID.KG_KAGEHUMI] = {
	...
	[SKID.ECL_SNOWFLIP] = {SkillName = "Snow Flip"},
	[SKID.ECL_PEONYMAMY] = {
	...
	[SKID.DC_FORTUNEKISS2] = {SkillName = "Lady Luck"},
	...
	[SKID.GC_DARKCROW] = {SkillName = "Dark Claw"},
	[SKID.RA_UNLIMIT] = {SkillName = "No Limits"},
	...
	[SKID.SU_BITE] = {SkillName = "Bite"},
	[SKID.SU_HIDE] = {SkillName = "Hide"},
	[SKID.SU_SCRATCH] = {SkillName = "Scratch"},
	[SKID.SU_STOOP] = {SkillName = "Stoop"},
	[SKID.SU_LOPE] = {SkillName = "Lope"},
	[SKID.SU_SPRITEMABLE] = {
	...
	[SKID.SU_TUNABELLY] = {SkillName = "Tuna Belly"},
	[SKID.SU_TUNAPARTY] = {SkillName = "Tuna Party"},
	...
	[SKID.SU_HISS] = {SkillName = "Hiss"},
	[SKID.SU_NYANGGRASS] = {
		SkillName = "Nyang Grass"
	},
	[SKID.SU_GROOMING] = {SkillName = "Grooming"},
	[SKID.SU_PURRING] = {SkillName = "Purring"},
	[SKID.SU_SHRIMPARTY] = {
	...
	[SKID.SU_MEOWMEOW] = {SkillName = "Meow Meow"},
	[SKID.SU_SPIRITOFLAND] = {
		SkillName = "Spirit Of Land"
	},
	[SKID.SU_CHATTERING] = {SkillName = "Chattering"},
	[SKID.SU_SPIRITOFSEA] = {
	...
	[SKID.AB_CONVENIO] = {SkillName = "Convenio"},
	...
	[SKID.AG_ALL_BLOOM] = {SkillName = "All Bloom"},
	...
	[SKID.AG_CLIMAX] = {SkillName = "Climax"},
	[SKID.AG_ROCK_DOWN] = {SkillName = "Rock Down"},
	...
	[SKID.IQ_FIRM_FAITH] = {SkillName = "Firm Faith"},
	...
	[SKID.IQ_JUDGE] = {SkillName = "Judgment"},
	...
	[SKID.IG_OVERSLASH] = {SkillName = "Overslash"},
	[SKID.IG_CROSS_RAIN] = {SkillName = "Cross Rain"},
	...
	[SKID.CD_ARBITRIUM] = {SkillName = "Arbitrium"},
	...
	[SKID.CD_EFFLIGO] = {SkillName = "Effligo"},
	[SKID.CD_COMPETENTIA] = {
	...
	[SKID.CD_RELIGIO] = {SkillName = "Religio"},
	[SKID.CD_BENEDICTUM] = {SkillName = "Benedictum"},
	...
	[SKID.MT_AXE_STOMP] = {SkillName = "Axe Stomp"},
	[SKID.MT_RUSH_QUAKE] = {SkillName = "Rush Quake"},
	[SKID.MT_M_MACHINE] = {
	...
	[SKID.ABC_DEFT_STAB] = {SkillName = "Deft Stab"},
	...
	[SKID.WH_WIND_SIGN] = {SkillName = "Wind Sign"},
	[SKID.WH_NATUREFRIENDLY] = {
		SkillName = "Nature's Friend"
	},
	[SKID.WH_HAWKRUSH] = {SkillName = "Hawk Rush"},
	[SKID.WH_HAWK_M] = {
	...
	[SKID.WH_GALESTORM] = {SkillName = "Gale Storm"},
	[SKID.WH_DEEPBLINDTRAP] = {
		SkillName = "Deep Blind Trap"
	},
	[SKID.WH_SOLIDTRAP] = {SkillName = "Solid Trap"},
	[SKID.WH_SWIFTTRAP] = {SkillName = "Swift Trap"},
	[SKID.WH_CRESCIVE_BOLT] = {
		SkillName = "Crescive Bolt"
	},
	[SKID.WH_FLAMETRAP] = {SkillName = "Flame Trap"},
	...
	[SKID.EM_ACTIVITY_BURN] = {SkillName = "AP Burn"},
	...
	[SKID.NW_WILD_FIRE] = {SkillName = "Wild Fire"},
	...
	[SKID.HN_RULEBREAK] = {SkillName = "Rule Break"},
	...
	[SKID.SKE_RISING_SUN] = {SkillName = "Rising Sun"},
	[SKID.SKE_NOON_BLAST] = {SkillName = "Noon Blast"},
	...
	[SKID.SKE_DAWN_BREAK] = {SkillName = "Dawn Break"},
	[SKID.SKE_TWINKLING_GALAXY] = {
		SkillName = "Twinkling Galaxy"
	},
	[SKID.SKE_STAR_BURST] = {SkillName = "Star Burst"},
	...
	[SKID.SS_TOKEDASU] = {SkillName = "Melt Away"},
	[SKID.SS_SHIMIRU] = {SkillName = "Infiltrate"},
	[SKID.SS_AKUMUKESU] = {
		SkillName = "Nightmare Erasion"
	},
	[SKID.SS_SHINKIROU] = {SkillName = "Mirage"},
	[SKID.SS_KAGEGARI] = {
	...
	[SKID.HAMI_CASTLE] = {SkillName = "Castling"},
	[SKID.HAMI_DEFENCE] = {
	...
	[SKID.HAMI_BLOODLUST] = {SkillName = "Blood Lust"},
	[SKID.HFLI_MOON] = {SkillName = "Moonlight"},
	[SKID.HFLI_FLEET] = {SkillName = "Flitting"},
	[SKID.HFLI_SPEED] = {
		SkillName = "Accelerated Flight"
	},
	[SKID.HFLI_SBR44] = {SkillName = "S.B.R.44"},
	[SKID.HVAN_CAPRICE] = {SkillName = "Caprice"},
	[SKID.HVAN_CHAOTIC] = {
	...
	[SKID.MH_OVERED_BOOST] = {SkillName = "Over Boost"},
	...
	[SKID.MH_STAHL_HORN] = {SkillName = "Stahl Horn"},
	[SKID.MH_GOLDENE_FERSE] = {
		SkillName = "Goldene Ferse"
	},
	[SKID.MH_STEINWAND] = {SkillName = "Stein Wand"},
	...
	[SKID.MH_MAGMA_FLOW] = {SkillName = "Magma Flow"},
	[SKID.MH_GRANITIC_ARMOR] = {
		SkillName = "Granitic Armor"
	},
	[SKID.MH_LAVA_SLIDE] = {SkillName = "Lava Slide"},
	[SKID.MH_PYROCLASTIC] = {
	...
	[SKID.MS_PARRYING] = {SkillName = "Parry"},
	[SKID.MS_REFLECTSHIELD] = {
		SkillName = "Shield Reflect"
	},
	[SKID.MS_BERSERK] = {SkillName = "Frenzy"},
	[SKID.MA_DOUBLE] = {
		SkillName = "Double Strafe"
	},
	[SKID.MA_SHOWER] = {
	...
	[SKID.MA_SKIDTRAP] = {SkillName = "Skid Trap"},
	[SKID.MA_LANDMINE] = {SkillName = "Land Mine"},
	[SKID.MA_SANDMAN] = {SkillName = "Sandman"},
	...
	[SKID.ML_PIERCE] = {SkillName = "Pierce"},
	[SKID.ML_BRANDISH] = {
		SkillName = "Brandish Spear"
	},
	...
	[SKID.ML_AUTOGUARD] = {SkillName = "Guard"},
	[SKID.ML_DEVOTION] = {SkillName = "Sacrifice"},
	[SKID.MER_MAGNIFICAT] = {SkillName = "Magnificat"},
	[SKID.MER_QUICKEN] = {
		SkillName = "Weapon Quicken"
	},
	[SKID.MER_SIGHT] = {SkillName = "Sight"},
	[SKID.MER_CRASH] = {SkillName = "Crash"},
	[SKID.MER_REGAIN] = {SkillName = "Regain"},
	[SKID.MER_TENDER] = {SkillName = "Tender"},
	[SKID.MER_BENEDICTION] = {
		SkillName = "Benediction"
	},
	[SKID.MER_RECUPERATE] = {SkillName = "Recuperate"},
	[SKID.MER_MENTALCURE] = {
		SkillName = "Mental Cure"
	},
	[SKID.MER_COMPRESS] = {SkillName = "Compress"},
	[SKID.MER_PROVOKE] = {SkillName = "Provoke"},
	[SKID.MER_AUTOBERSERK] = {SkillName = "Berserk"},
	[SKID.MER_DECAGI] = {
		SkillName = "Decrease AGI"
	},
	[SKID.MER_SCAPEGOAT] = {SkillName = "Scapegoat"},
	[SKID.MER_LEXDIVINA] = {SkillName = "Lex Divina"},
	[SKID.MER_ESTIMATION] = {SkillName = "Sense"},
	[SKID.MER_KYRIE] = {
		SkillName = "Kyrie Eleison"
	},
	[SKID.MER_BLESSING] = {SkillName = "Blessing"},
	[SKID.MER_INCAGI] = {
		SkillName = "Increase Agility"
	},
	...
	[SKID.EL_FIRE_CLOAK] = {SkillName = "Fire Cloak"},
	[SKID.EL_FIRE_MANTLE] = {
	...
	[SKID.EL_WATER_DROP] = {SkillName = "Water Drop"},
	[SKID.EL_WATER_BARRIER] = {
		SkillName = "Water Barrier"
	},
	[SKID.EL_WIND_STEP] = {SkillName = "Wind Step"},
	[SKID.EL_WIND_CURTAIN] = {
		SkillName = "Wind Curtain"
	},
	[SKID.EL_ZEPHYR] = {SkillName = "Zephyr"},
	[SKID.EL_SOLID_SKIN] = {SkillName = "Solid Skin"},
	...
	[SKID.EL_HEATER] = {SkillName = "Heater"},
	[SKID.EL_TROPIC] = {SkillName = "Tropic"},
	[SKID.EL_AQUAPLAY] = {SkillName = "Aquaplay"},
	[SKID.EL_COOLER] = {SkillName = "Cooler"},
	[SKID.EL_CHILLY_AIR] = {SkillName = "Chilly Air"},
	[SKID.EL_GUST] = {SkillName = "Gust"},
	[SKID.EL_BLAST] = {SkillName = "Blast Mine"},
	[SKID.EL_WILD_STORM] = {SkillName = "Wild Storm"},
	[SKID.EL_PETROLOGY] = {SkillName = "Geologia"},
	[SKID.EL_CURSED_SOIL] = {
		SkillName = "Cursed Soil"
	},
	[SKID.EL_UPHEAVAL] = {SkillName = "Upheaval"},
	[SKID.EL_FIRE_ARROW] = {SkillName = "Fire Arrow"},
	[SKID.EL_FIRE_BOMB] = {SkillName = "Fire Bomb"},
	[SKID.EL_FIRE_BOMB_ATK] = {
		SkillName = "Fire Bomb Attack"
	},
	[SKID.EL_FIRE_WAVE] = {SkillName = "Fire Wave"},
	[SKID.EL_FIRE_WAVE_ATK] = {
		SkillName = "Fire Wave Attack"
	},
	[SKID.EL_ICE_NEEDLE] = {SkillName = "Ice Needle"},
	[SKID.EL_WATER_SCREW] = {
	...
	[SKID.EL_WIND_SLASH] = {SkillName = "Wind Slash"},
	[SKID.EL_HURRICANE] = {SkillName = "Hurricane"},
	...
	[SKID.EL_STONE_RAIN] = {SkillName = "Stone Rain"},
	...
	[SKID.EM_EL_FLAMEROCK] = {SkillName = "Flame Rock"},
	[SKID.EM_EL_COLD_FORCE] = {SkillName = "Cold Force"},
	[SKID.EM_EL_CRYSTAL_ARMOR] = {
		SkillName = "Crystal Armor"
	},
	[SKID.EM_EL_AGE_OF_ICE] = {SkillName = "Ice Age"},
	...
	[SKID.EM_EL_STORM_WIND] = {SkillName = "Storm Wind"},
	[SKID.EM_EL_EARTH_CARE] = {SkillName = "Earth Care"},
	[SKID.EM_EL_STRONG_PROTECTION] = {
		SkillName = "Strong Protection"
	},
	[SKID.EM_EL_AVALANCHE] = {SkillName = "Avalanche"},
	...
	[SKID.ABR_NET_REPAIR] = {SkillName = "Net Repair"},
	...
	[SKID.GD_SOULCOLD] = {SkillName = "Cold Heart"},
	[SKID.GD_HAWKEYES] = {SkillName = "Sharp Gaze"},
	[SKID.GD_BATTLEORDER] = {
